...
a version control system like Git in conjunction with a service like `GitHub <https://github.com>`__. 
...
you can use something `GitHub Gists <https://gist.github.com>`__ or `Pastebin <https://pastebin.com>`__. 

For more information on how to use Git, including the Git CLI tools and setting up a respository on GitHub, check out
the `GitHub help pages <https://help.github.com>`__. 
