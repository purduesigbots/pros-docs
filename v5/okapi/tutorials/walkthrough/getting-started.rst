...
installed, you can check the output of ``pros conduct info-project``. Additionally, OkapiLib's
...
and then install it by running ``pros conduct fetch path/to/okapilib.zip``. Once OkapiLib is
