...
.. code-block: cpp
   ...
   okapi::ControllerButton btnUp(E_CONTROLLER_DIGITAL_R1);
   okapi::ControllerButton btnDown(E_CONTROLLER_DIGITAL_R2);
   okapi::Motor lift (LIFT_MOTOR);
...
.. code-block: cpp
   ...
   okapi::ControllerButton btnDown(E_CONTROLLER_DIGITAL_R2);
   okapi::Motor lift (LIFT_MOTOR);
   auto liftControl = okapi::AsyncControllerFactory::posIntegrated(lift);
   int goalHeight = 0;
